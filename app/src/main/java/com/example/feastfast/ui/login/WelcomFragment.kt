...
class WelcomFragment : Fragment() {
    var binding :FragmentWelcomBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.login?.setOnClickListener{
            it.findNavController().navigate(R.id.action_welcomFragment_to_loginFragment)
        }
        binding?.signup?.setOnClickListener{
            it.findNavController().navigate(R.id.action_welcomFragment_to_signupFragment)
        }
