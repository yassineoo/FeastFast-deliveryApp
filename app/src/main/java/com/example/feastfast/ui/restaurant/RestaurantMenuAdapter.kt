...
class RestaurantMenuAdapter(fragment: FragmentActivity,val data:List<String>,val currentRestaurant: Restaurant,val menuItems: List<MenuItem>?) : FragmentStateAdapter(fragment) {
